...
public class IntEditorField : EditorField
{
    [SerializeField]
...
class IntField<Class> : Field<Class, ValueType>
{
    public IntField(Ref<Class> refRootData, IntEditorField editorField, DepthFieldInfo depth) : base(refRootData, editorField, depth)
    {
    ...
    {
        ((IntEditorField)editorField).SetValueWithoutNotify(Value);
    }
}
